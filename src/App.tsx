...
import { Section, Title, TOCEntry } from './Section';
import { ContentsContext } from './Section';
            ...
            >
                <UnofficialContext.Provider value={showUnofficial}>
                    <BlurContext.Provider value={blur}>
                        <div ref={appRef} className={classNames('App', language, { 'no-unofficial': !showUnofficial })}>
                            ...
                            <Contents entryList={tocRef.current as TOCEntry[]} />
                            ...
                            <ContentsContext.Provider value={[0, updateToC, false]}>
                                <Title id="rules-vs-conventions" className="major">
                                    Rules vs Conventions
                                </Title>
                                <P>
                                    Any language has <Word>rules</Word> that govern the basic features of the language
                                    and what is considered "correct" or "incorrect". For example, in English you put
                                    adjectives <B>before</B> nouns. That's just a rule. However, languages also have{' '}
                                    <Word>conventions</Word> which determine what sounds "normal" to say. For example,
                                    in English you would say <Eng>"I am happy about that"</Eng> rather than{' '}
                                    <Eng>"I am happy toward that"</Eng> or <Eng>"I am happy because of that"</Eng>. All
                                    of these sentences are equally correct as far as the rules of English go, but the
                                    second two sound awkward, because, <B>by convention</B>, you wouldn't use{' '}
                                    <Eng>"towards"</Eng> or <Eng>"because of"</Eng> to describe the cause of your
                                    happiness.
                                </P>
                                <P>
                                    ...
                                    applies 100% of the time. Context matters a lot in toki ma, so be sure to check out
                                    the{' '}
                                ...
                                <P>
                                    Before we start with grammar, it's important to know how the flexible vocabulary of
                                    toki ma can be derived from the base definitions of its words. Aside from a select
                                    few irregular words,{' '}
                                    <B>
                                        any noun, verb, or modifier can be converted to one of the other two word forms
                                    </B>{' '}
                                ...
                                <Section>
                                    ...
                                    <P>
                                        <Word>Base nouns</Word> are very simple to convert into verbs and modifiers.
                                        When a <B>noun</B> is used as a <B>verb</B>, it just means the verb phrase{' '}
                                    ...
                                    <P>
                                        ...
                                        As a <B>verb</B> it means <Eng>"is a person"</Eng> or{' '}
                                        <Eng>"to be a person"</Eng>.
                                        <br />
                                ...
                                <Section>
                                    ...
                                    <P>
                                        <Word>Base modifiers</Word> are also quite easy to convert. When a{' '}
                                        <B>modifier</B> is used as a <B>noun</B>, it becomes the{' '}
                                        <Word>abstract object</Word> of the modifier. Think of it like adding{' '}
                                        <Eng>"-ness"</Eng> to the word. When used as a <B>verb</B>, it also just means{' '}
                                ...
                                <Section>
                                    ...
                                    <P>
                                        <Word>Base verbs</Word> are the trickiest of the three, but still not very
                                        tough. When a <B>verb</B> is used as a <B>noun</B>, it becomes the{' '}
                                        ...
                                        <Eng>"[generic object]-like"</Eng> or{' '}
                                        <Eng>"resembling [the generic object]"</Eng>.
                                    </P>
                                    <P>
                                        As a <B>verb</B>, <TM>moku</TM> means <Eng>"to eat"</Eng> or{' '}
                                        <Eng>"to consume"</Eng>
                                        .<br />
                                    ...
                                    <P>
                                        When used as a modifier, the idea of{' '}
                                        <Eng>"resembling [the generic object]"</Eng> doesn't necessarily mean resembling
                                        in looks. Rather, it requires considering{' '}
                                        <B>what quality or qualities make that object unique</B> in the context of its
                                        base verb. For example, the thing that makes food be food-like is that it is
                                        able to be eaten, regardless of how it looks. Something that is seat-like simply
                                        means that it can be sat upon (or maybe that it is <B>intended</B> to be sat
                                        upon), not that it has four legs and a back and looks like the stereotypical
                                        idea of a chair.
                                    </P>
                                </Section>
                                <P>
                                    ...
                                    <a href="https://toki-ma.com/?page=dictionary">the dictionary</a> for proper
                                    definitions of irregulars in all forms.
                                </P>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        The most basic particle <TM>li</TM> <B>marks the verb</B> of a sentence. Without
                                        it, you could only talk about nouns and adjectives!
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>mi li moku</TM>
                                    ...
                                    <P>
                                        It's a bit confusing here just due to how English works, but it's very important
                                        not to get confused thinking <TM>li</TM> means <Eng>"to be"</Eng>. That comes
                                        from the verb forms of the words <TM>moku</TM>, <TM>jan</TM>, and <TM>lete</TM>{' '}
                                        themselves. The role of <TM>li</TM> is <B>only</B> to mark that the following
                                        word <B>should be interpreted as a verb</B>.
                                    </P>
                                    <P>
                                        While these translations are valid, it's important to note that <TM>li</TM>{' '}
                                        alone does not say anything about the <Word>tense</Word>, meaning <B>past</B> (
                                        <Eng>"I was eating"</Eng>), <B>present</B> (<Eng>"I am eating"</Eng>), or{' '}
                                        <B>future</B> (<Eng>"I will be eating"</Eng>), or about the <Word>aspect</Word>,
                                        meaning <B>perfective</B> (completed action, <Eng>I ate</Eng>), continuous
                                        (ongoing action, <Eng>I am eating</Eng>), or repeated (habitual action,{' '}
                                        <Eng>I eat</Eng>
                                        ). These are all valid translations of the sentence <TM>mi li moku</TM>. Which
                                        one is meant must be inferred through context.
                                    </P>
                                    <P>
                                        Later we will learn more ways to specify tense and aspect to remove this
                                        ambiguity. For now, example sentences will just assume one for convenience.
                                    </P>
                                    <P>
                                    ...
                                    <P>
                                        In English this sounds a bit awkward, but it is a clearly communicated concept
                                        and is completely acceptable in toki ma. How often you might say such a thing is
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        communication in toki ma is often driven by context to resolve ambiguities
                                        without having to resort to much longer descriptions of very simple things.
                                        Being specific is often not a major goal of a toki ma speaker in casual
                                        conversation, because the listener can often figure out the details without
                                        major problems.
                                    </P>
                                    <P>
                                        When you read examples in this guide,{' '}
                                        <B>
                                            don't worry if you didn't get it exactly the same as the stated translation
                                        </B>
                                        . It doesn't mean you were wrong if you read <TM>mi li moku</TM> as{' '}
                                        <Eng>"I am eating"</Eng> and the translation says <Eng>"I eat"</Eng>. Keep this
                                ...
                                <Section>
                                    ...
                                    <P>
                                        We've learned how to derive words in the different parts of speech, but we
                                        haven't learned how to recognize words in different parts of speech. What makes{' '}
                                        <TM>moku</TM> sometimes mean <Eng>"to eat"</Eng>, sometimes mean{' '}
                                        <Eng>"food"</Eng> and sometimes mean <Eng>"edible"</Eng>? It all has to do with
                                        where the word is in the sentence.
                                    </P>
                                    <P>
                                        You know now that <TM>li</TM> makes the following word a <B>verb</B>. That is
                                        the <B>only</B> way that a word acts as a verb. When a word appears on its own,
                                        it's a <B>noun</B>, such as at the beginning of a sentence or after a{' '}
                                        <B>preposition</B>. A word following a noun or verb is a <B>modifier</B>.
                                        Modifiers can also follow other modifiers to stack together. We'll talk more
                                        about modifiers later.
                                    ...
                                    <P>
                                        ...
                                        <Eng>"to"</Eng>, <Eng>"with"</Eng>, etc. There are only a few specific
                                        prepositions in toki ma, and they never act like any other part of speech. There
                                        are individual sections throughout the guide for each of the different
                                        prepositions.
                                    </P>
                                    <P>
                                        Lastly, there are <B>particles</B>. Particles are words that don't have meaning
                                        on their own, but are used to affect other parts of the sentence. For example,{' '}
                                ...
                                <Section>
                                    ...
                                    <P>
                                        The particle <TM>e</TM> marks <TM>kili</TM> as the object of the verb{' '}
                                        <TM>moku</TM>. It's important to note that <TM>e</TM> is considered a
                                        preposition, not a particle. This is relevant because of word order, which we
                                        will discuss in a moment. Here are a few more examples:
                                    </P>
                                    <Examples>
                                        <Ex>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        The particle <TM>o</TM> works the same way as <TM>li</TM>, marking the verb,
                                        except that it turns the statement into a <B>recommendation</B>,{' '}
                                        <B>suggestion</B>, or what the speaker believes <B>should</B> happen.
                                    </P>
                                    <Examples>
                                        <Ex>
                                    ...
                                    <P>
                                        When using <TM>o</TM> followed by simply a specific <B>animate</B> noun, it can
                                        be used as a <Word>vocative</Word> expression, calling for someone's attention.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>o jan Ken</TM>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        Modifiers act as <Word>adjectives</Word> and <Word>adverbs</Word>, with the
                                        modifier coming <B>after</B> the modified word, not before as it is done in
                                        English. These modifiers can affect nouns as <B>adjectives</B>, or verbs as{' '}
                                        <B>adverbs</B>.
                                    </P>
                                    <Examples>
                                        <Ex>
                                    ...
                                    <P>
                                        Modifiers can also affect <B>other modified phrases</B>, connecting together to
                                        form modifier chains. When modifiers are chained, each modifier{' '}
                                    ...
                                    <P>
                                        Wait a second, why does that second sentence say <Eng>"many good people"</Eng>{' '}
                                        and not <Eng>"a very good person"</Eng>? Remember that modifiers chain together{' '}
                                        <B>but apply to the whole noun phrase so far</B>, not just to the previous
                                        modifier. <TM>pona</TM> applies to <TM>jan</TM>, so now <TM>mute</TM> applies to
                                        the entire phrase <TM>jan pona</TM>, not just to <TM>pona</TM>. Think of it like
                                        parentheses in math class: <TM>((((jan pasan) lamo) pona) mute)</TM> -{' '}
                                    ...
                                    <Section>
                                        ...
                                        <P>
                                            The preposition <TM>pi</TM> is used for the <Word>genitive case</Word>.
                                            Think of the genitive as a relational case, relating one thing to another.
                                            The best equivalence in English is the word <Eng>"of"</Eng>. It is very
                                            useful for <B>regrouping modifiers</B> rather than just chaining them
                                            endlessly to one noun.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>jan pona mute</TM>
                                        ...
                                        <P>
                                            It is also good for relating a noun to another noun, as is the standard use
                                            of the word <Eng>"of"</Eng>.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>tomo moku</TM>
                                        ...
                                        <P>
                                            Like modifiers, <TM>pi</TM>-phrases also <B>chain onto each other</B>,
                                            making that last example read as: <TM>((tomo pi mama) pi mama mi)</TM> which
                                            would mean <Eng>"((parent's house) of my parent)"</Eng>, not{' '}
                                    ...
                                    <Section unofficial>
                                        ...
                                        <P>
                                            ...
                                            roughly means <Eng>"my grandparent's house"</Eng>, however there are some
                                            cases where it can cause issues.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>tomo pi moku</TM>
                                            ...
                                            <Ex>
                                                ...
                                                <Answer>
                                                    <Eng>"the food-related home bathroom"</Eng>...? That's about the
                                                    best translation possible.
                                                    <br />
                                                    Grouped as <Eng>"(((place of dirtiness) of home) of food)"</Eng>;
                                                    see how <Eng>"food"</Eng> applies to the entire thing, not just the{' '}
                                                    <Eng>"house"</Eng>.
                                                </Answer>
                                            </Ex>
                                        </Examples>
                                        ...
                                        <Examples>
                                            ...
                                            <Ex>
                                                ...
                                                <Answer>
                                                    ...
                                                    <Eng>
                                                        "((house of food) of (the sibling of (the parent of my
                                                        parent)))"
                                                    </Eng>
                                                </Answer>
                                            </Ex>
                                        ...
                                        <P>
                                            With this addition, <TM>je</TM> becomes the more common preposition to
                                            combine words that represent a <B>single concept</B>, such as{' '}
                                            <Eng>"bathroom"</Eng>, <Eng>"restaurant"</Eng>, or <Eng>"grandmother"</Eng>.
                                            If all you wanted to say was <Eng>"restaurant"</Eng>, you could use either{' '}
                                            <TM>pi</TM> or <TM>je</TM> to get the point across, but <TM>je</TM> would be
                                            the preferred term, as it keeps the individual relationships{' '}
                                            <B>closely tied into one single concept</B>. This way, when you do end up
                                            using <TM>tomo je moku</TM> within a larger phrase, it's already in the same
                                            form you're used to hearing. This improves understanding and speeds up
                                            communication.
                                        </P>
                                        <P>
                                            This idea of <TM>je</TM> implying closer relationships may not <B>always</B>{' '}
                                            hold true in more complex <TM>pi</TM>/<TM>je</TM> phrases, but it may have
                                            some implications in more isolated cases.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>tapa pi moku</TM>
                                            ...
                                            <Ex>
                                                <TM>tapa je moku</TM>
                                                <Answer>
                                                    <Eng>"food container"</Eng>, implying a container designed for
                                                    holding food, such as a lunchbox, regardless of whether it has food
                                                    in it right now
                                                </Answer>
                                            </Ex>
                                        </Examples>
                                        <P>
                                            These are likely interchangeable in most contexts, but the implication is
                                            still there in times when it may be more important.
                                        </P>
                                    </Section>
                                    <Section>
                                        <Title id="li-lon">
                                        ...
                                        <P>
                                            ...
                                            <B>if the word is already a base noun or base modifier</B>. What if it's a
                                            base verb? How do you say something <Eng>"is food"</Eng> or{' '}
                                            <Eng>"is edible"</Eng> using the other derivations of <TM>moku</TM>? You
                                            can't say <TM>li moku</TM>, because that means <Eng>"is eating"</Eng>. What
                                            do you do?
                                        ...
                                        <P>
                                            ...
                                            <Eng>"to be"</Eng> or <Eng>"to exist"</Eng>. This allows you to use
                                            modifiers or <TM>pi</TM>-phrases to use modifier or noun forms of any word
                                            you please.
                                        </P>
                                        <P>
                                        ...
                                        <Examples>
                                            <Ex>
                                                ...
                                                <Answer>
                                                    <Eng>"This is edible"</Eng>, literally{' '}
                                                    <Eng>"This exists edibly"</Eng>
                                                </Answer>
                                            </Ex>
                                            <Ex>
                                        ...
                                        <Examples>
                                            <Ex>
                                                <TM>li lon [word]</TM>
                                                <Answer noblur>
                                                    always uses <TM>[word]</TM> as a <B>modifier</B>, regardless of its
                                                    base part of speech
                                                </Answer>
                                            </Ex>
                                            <Ex>
                                        ...
                                        <P>
                                            Because nouns derived from base modifiers are the <B>abstract object</B> of
                                            the modifier, it's uncommon that you'd use{' '}
                                            <TM>li lon pi [base modifier]</TM> to talk about a base modifier as a noun
                                            in most cases. You'd much more likely say <TM>ni li suli</TM>,{' '}
                                            <Eng>"this is large"</Eng>, than you'd say <TM>ni li lon pi suli</TM>,{' '}
                                            <Eng>"this is largeness"</Eng>. In general this is most useful for using{' '}
                                            <B>base verbs</B> in their noun or modifier forms.
                                        </P>
                                    </Section>
                                    <Section>
                                        <Title id="li-kama">
                                        ...
                                        <P>
                                            Many words in toki ma, especially modifiers, represent <B>states</B> rather
                                            than <B>actions</B>. As seen in the section on{' '}
                                            <a href="#word-derivations">word derivations</a>, the usual verb derivation
                                            of a modifier is <Eng>"to be [modifier]"</Eng>, such as <TM>li lape</TM>:{' '}
                                            <Eng>"to be sleeping"</Eng>. This allows us to talk about{' '}
                                            <B>whether something is or is not in a certain state</B>, but it doesn't let
                                            us talk about <B>the act of transitioning into that state</B>. For this we
                                            need the verb <TM>kama</TM>.
                                        </P>
                                        <P>
                                        ...
                                        <P>
                                            If you want to say that something <B>becomes something else</B>, using a
                                            noun, you can use <TM>kama e [noun]</TM>.
                                        </P>
                                        <Examples>
                                            <Ex>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        This isn't a complete sentence, it's a <Word>noun clause</Word>. It simply
                                        refers to the concept of eating fruit, <B>as an entire noun</B>. This allows it
                                        to be used as a <B>subject</B> or <B>object</B> of a verb. Let's take a look at
                                        an example:
                                    </P>
                                    <Examples>
                                        <Ex>
                                    ...
                                    <P>
                                        Notice how <TM>te li moku e kili</TM> is preceded by <TM>e</TM>, making the
                                        entire phrase a <B>noun clause</B>; technically it's a{' '}
                                        <B>noun clause object of a verb</B> for you linguists out there. Let's look at
                                        another example:
                                    </P>
                                    <Examples>
                                        <Ex>
                                    ...
                                    <P>
                                        ...
                                        <Eng>"eating fruit"</Eng> are all simply <B>noun clauses</B> once again
                                        referring to the concept of eating fruit, all marked by <TM>te</TM>, and all
                                        valid interpretations of <TM>te li moku e kili</TM>. In this case, again for you
                                        linguists out there, this is a <B>noun clause subject of a verb</B>.
                                    </P>
                                    <P>
                                        As previously stated, <TM>te</TM> can also mark <Word>relative clauses</Word>.
                                        While noun clauses act as a noun (surprise surprise), relative clauses, also
                                        known as <Word>adjective clauses</Word>, are phrases that act as an{' '}
                                        <B>adjective</B>.
                                    </P>
                                    <Examples>
                                        <Ex>
                                    ...
                                    <P>
                                        ...
                                        <Word>relative clause</Word>. It acts as an adjective, enhancing the description
                                        of the person we are talking about. Here are more examples:
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                    ...
                                    <P>
                                        These relative clauses have one minor difference to the first example: they have
                                        a <Word>dangling preposition</Word> at the end. This happens because the{' '}
                                        <B>subject</B> of our sentence would normally be the{' '}
                                        <B>object of a preposition</B> if we were to rearrange the relative clause to
                                        stand on its own. Let's analyze the first example further to understand this
                                        better.
                                    </P>
                                    <Examples>
                                        <Ex>
                                    ...
                                    <P>
                                        The subject of the sentence is <TM>kili</TM>, <Eng>"the fruit</Eng>. Let's drop
                                        the <TM>te</TM> and rearrange it.
                                    </P>
                                    <Ex>
                                        <TM>
                                    ...
                                    <P>
                                        This is now a complete sentence, but the <B>subject has changed</B> to{' '}
                                        <TM>mi</TM>. We are now talking about ourselves eating the fruit.{' '}
                                    </P>
                                    <P>
                                        Without using <TM>te</TM>, we could only ever talk about{' '}
                                        <B>the thing doing the action</B> as the subject of a sentence. If we ever want
                                        to talk about the <B>object of a preposition</B> rather than the subject of the
                                        action, we must rearrange the sentence using <TM>te</TM>, and{' '}
                                    ...
                                    <P>
                                        There is one last thing to mention about using <TM>te</TM> in a sentence.
                                        Whenever <TM>te</TM> comes after the preposition <TM>e</TM>, the <TM>e</TM> can
                                        simply be dropped. Additionally, whenever <TM>te</TM> comes before <TM>li</TM>,
                                        the <TM>li</TM> can be dropped. These can combine to cause the construction{' '}
                                        <TM>... e te li ...</TM> to simply become <TM>... te ...</TM>.
                                    </P>
                                    <P>
                                        While this is allowed, it is suggested that you only drop the <TM>e</TM> and
                                        keep it as <TM>te li</TM> in many cases, as it can become harder to parse with
                                    ...
                                    <P>
                                        This is very commonly used, though not required. There may be cases where it
                                        feels more natural to keep one or both in the sentence. This guide will mostly
                                        use the <TM>te li</TM> construction, without the <TM>e</TM>.
                                    </P>
                                    ...
                                    <Section unofficial>
                                        ...
                                        <P>
                                            Dropping the <TM>li</TM> from <TM>te li</TM> can cause confusion, because it
                                            becomes unclear whether the following word is a verb or a noun until later
                                            in the clause. However, it's convenient to not have to say two words every
                                            time you want to start a clause with a verb. The contraction <TM>ti</TM> has
                                            been proposed to solve this issue. <TM>ti</TM> is identical in meaning to{' '}
                                            <TM>te li</TM>, however it is shorter to write and say. It allows for the
                                            brevity of dropping <TM>li</TM> without the loss of clarity.
                                        </P>
                                        <Examples>
                                            <Ex>
                                        ...
                                        <P>
                                            This may seem trivial in short sentences, but as sentences get longer and
                                            more complex it really adds up. Using <TM>ti</TM> gives smoother, less bulky
                                            sentences.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                ...
                                                <Answer>
                                                    <Eng>"I can try to talk to that man who causes violence"</Eng>
                                                </Answer>
                                            </Ex>
                                            <Ex>
                                        ...
                                        <P>
                                            There is one difference between <TM>te li</TM> and <TM>ti</TM> which only
                                            occurs when <B>dangling prepositions</B> are involved. Consider the
                                            following phrases using <TM>te li</TM>:
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>jan te li toki ki mi</TM>
                                                <Answer>
                                                    <Eng>"person that speaks to me"</Eng>
                                                </Answer>
                                            </Ex>
                                            <Ex>
                                                <TM>jan te mi li toki ki</TM>
                                                <Answer>
                                                    <Eng>"person that I speak to"</Eng>
                                                </Answer>
                                            </Ex>
                                            <Ex>
                                                <TM>jan te li toki ki</TM>
                                                <Answer>
                                                    <Eng>"person that is spoken to"</Eng>
                                                </Answer>
                                            </Ex>
                                        </Examples>
                                        <P>
                                            Notice how in the first phrase, the person is the one doing the action{' '}
                                            <TM>toki</TM>, however in the second two phrases, there is some other
                                            subject doing the action <TM>toki</TM>, or at least an{' '}
                                            <B>implied subject</B> in the third example. However, if you compare the
                                            first and third sentences word-by-word, you may notice that you can't
                                            actually know whether <TM>jan</TM> is the subject <B>until the very end</B>.
                                        </P>
                                        <P>
                                            To solve this problem, if <TM>jan</TM> is the subject, you would use{' '}
                                            <TM>ti</TM>, and if <TM>jan</TM> is the object of a preposition, you would
                                            use the longer <TM>te li</TM> to show that the clause is intentionally being
                                            left without an explicit subject.
                                        </P>
                                        <Examples>
                                            <Ex>
                                        ...
                                        <Section unofficial>
                                            ...
                                            <P>
                                                ...
                                                <TM>te</TM> will change to <TM>ta</TM>, and the existing word{' '}
                                                <TM>ta</TM> meaning <Eng>"mirrored"</Eng> or <Eng>"opposite"</Eng> will
                                                change back to its older form <TM>jasi</TM>. This is to avoid having the
                                                words <TM>te</TM> and <TM>ti</TM> sound too similar, as some speakers'
                                                native languages may not fully differentiate the two vowel sounds. This
                                                change is not fully confirmed yet, but it is important to be aware that
                                                it may happen.
                                            </P>
                                        </Section>
                                    </Section>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        <ol>
                                            ...
                                            <li>
                                                Place commas after <TM>te</TM> clauses before moving on to the rest of
                                                the sentence
                                            </li>
                                        </ol>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        ? That's right, we need a new word: <TM>no</TM>. The word <TM>no</TM> is used
                                        for <Word>negation</Word>. It can be used like any other modifier to affect a
                                        noun, verb, or other modifier.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                    ...
                                    <P>
                                        ...
                                        Currently this is also used to mean <Eng>"zero"</Eng>, but a specific word for
                                        the number 0 may be added in the future.
                                    ...
                                    <Section unofficial>
                                        ...
                                        <P>
                                            ...
                                            construction <TM>li no</TM> can be shortened to just <TM>no</TM>. If{' '}
                                            <TM>o</TM> is used instead of <TM>li</TM>, however, this cannot be done.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>
                                ...
                                <Section>
                                    ...
                                    <Section>
                                        ...
                                        <P>
                                            As a verb, the word <TM>wa</TM> means <Eng>"to cause"</Eng>. This is most
                                            often used with a <TM>te</TM>-clause to demonstrate causation of an action.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>si li wa te mi li pasan</TM>
                                                <Answer>
                                                    <Eng>"You make me happy"</Eng>, literally{' '}
                                                    <Eng>"You cause that I be happy"</Eng>
                                                </Answer>
                                            </Ex>
                                        </Examples>
                                        <P>
                                            This sentence is completely valid, but an alternate form is also very
                                            common: use <TM>wa</TM> as a modifier to the verb <TM>pasan</TM> to indicate
                                            that it is being <B>caused</B>.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>si li pasan wa</TM>
                                                <Answer>
                                                    <Eng>"You cause happiness"</Eng>
                                                </Answer>
                                            </Ex>
                                        </Examples>
                                        <P>
                                            But what happened to the original subject of that <TM>te</TM>-clause,{' '}
                                            <TM>mi</TM>? This no longer says{' '}
                                            <Eng>
                                                "You make <B>me</B> happy"
                                            </Eng>
                                            . To figure out how to fit this in, we first need to break down the
                                            structure of a causative statement.
                                        </P>
                                        <P>
                                            In the sentence <Eng>"you make me happy"</Eng>, there are four components.
                                            <ol>
                                                <li>
                                                    The <Word>causer</Word>, <Eng>"you"</Eng>, is the thing that is
                                                    actively <B>causing</B> the action to occur.
                                                </li>
                                                <li>
                                                    The <Word>causation</Word> is the <B>action of causing</B> something
                                                    to happen. It is the action that the <B>causer</B> is taking, in
                                                    this case indicated by the word <Eng>"make"</Eng>.
                                                </li>
                                                <li>
                                                    The <Word>agent</Word>, <Eng>"me"</Eng>, is the thing that is being
                                                    made to take action because of the <B>causer</B>.
                                                </li>
                                                <li>
                                                    The <Word>action</Word>, <Eng>"to be happy"</Eng>, is the action
                                                    that is being taken by the <B>agent</B> because of the <B>causer</B>
                                                    .
                                                </li>
                                            </ol>
                                            If that's not confusing enough, consider the summarized form:{' '}
                                            <B>
                                                The <Word>causer</Word>'s <Word>causation</Word> induces the{' '}
                                                <Word>agent</Word> to peform the <Word>action</Word>
                                            </B>
                                            .
                                        </P>
                                        <P>
                                            The important thing to note is that there are two actions happening at the
                                            same time here, and <B>one directly affects the other</B>. In the case of
                                            the sentence <TM>si li wile te mi li pasan</TM>,{' '}
                                            <Eng>"You want me to be happy"</Eng>, your action of <Eng>"wanting"</Eng>{' '}
                                            doesn't actually affect my action of <Eng>"being happy"</Eng>. However, in
                                            the causative example from before, <TM>si li wa te mi li pasan</TM>, your
                                            action of <Eng>"causing"</Eng> directly affects my action of{' '}
                                            <Eng>"being happy"</Eng>.
                                        </P>
                                        <P>
                                            It is because of this cause-and-effect relationship that you can consider
                                            the <B>agent</B> to be something like the <B>recipient of the causation</B>.
                                            To mark recipients, we use the preposition <TM>ki</TM>, finally allowing us
                                        ...
                                        <Examples>
                                            <Ex>
                                                ...
                                                <Answer>
                                                    <Eng>"You make me happy"</Eng>, literally{' '}
                                                    <Eng>"You cause-to-be-happy, received by me"</Eng>
                                                </Answer>
                                            </Ex>
                                        </Examples>
                                        <P>
                                            It's hard to show a direct translation of this in English, simply because we
                                            don't have an exact equivalent, but hopefully that example makes it clear.
                                        </P>
                                        <P>
                                            When using this causative-<TM>wa</TM> form, the first <TM>ki</TM> phrase is
                                            conventionally interpreted as marking the <B>agent</B>. This is, of course,
                                            only relevant if the sentence has multiple <TM>ki</TM> prepositions.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>
                                        ...
                                        <P>
                                            This causative-<TM>wa</TM> is also used to make active verb forms out of
                                            base modifiers.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                ...
                                                <Answer>
                                                    <Eng>"I kill them"</Eng>, literally{' '}
                                                    <Eng>"I cause them to be dead"</Eng>
                                                </Answer>
                                            </Ex>
                                            <Ex>
                                                <TM>mi li ante wa ki na</TM>
                                                <Answer>
                                                    <Eng>"I change that"</Eng>, literally{' '}
                                                    <Eng>"I cause that to be different"</Eng>, or{' '}
                                                    <Eng>"I cause that to be changed"</Eng>
                                                </Answer>
                                            </Ex>
                                            <Ex>
                                                <TM>mi li sapi wa ki tomo</TM>
                                                <Answer>
                                                    <Eng>"I clean the house"</Eng>, literally{' '}
                                                    <Eng>"I cause the house to be clean"</Eng>
                                                </Answer>
                                            </Ex>
                                        </Examples>
                                        <P>
                                        ...
                                        <Examples>
                                            <Ex>
                                                ...
                                                <Answer>
                                                    <Eng>"I create a clay figurine"</Eng>, literally{' '}
                                                    <Eng>
                                                        "I cause-to-become-existent a small art-related clay person"
                                                    </Eng>
                                                </Answer>
                                            </Ex>
                                        </Examples>
                                        <P>
                                            In general, modifiers on the verb that come before the <TM>wa</TM> can be
                                            read as applying to the <B>action</B>, whereas modifiers that come after the{' '}
                                            <TM>wa</TM> apply to the <B>causation</B>. This usually doesn't really
                                            matter, but it can have an effect in some situations.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>mi li kipisi mute mulu wa wiki ki sa</TM>
                                                <Answer>
                                                    <Eng>"I quickly cause the object to be completely cut up"</Eng>,
                                                    literally{' '}
                                                    <Eng>"I quickly-cause-to-be-totally-very-divided the object"</Eng>
                                                </Answer>
                                            </Ex>
                                        </Examples>
                                        <P>
                                            When other prepositions are involved besides the agent-marking <TM>ki</TM>,
                                            they always apply to the <B>action</B>, never to the <B>causation</B>.
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>
                                                    mama mi li tawa wa ki mi ki esun an suno pisile nen te li lanpan
                                                    esun e pan
                                                </TM>
                                                <Answer>
                                                    <Eng>
                                                        "My parent made me go to the store yesterday in order to buy
                                                        bread"
                                                    </Eng>
                                                </Answer>
                                            </Ex>
                                        ...
                                        <P>
                                            If for some reason you need more prepositions to apply directly to{' '}
                                            <TM>wa</TM>, use the longer form with <TM>wa</TM> as main verb. This is
                                            specifically very rare, but it is still important to remember that{' '}
                                            <B>all of these sentences</B> can be expressed using the longer form as
                                            well. For more unified concepts such as <TM>li kama lon wa</TM>,{' '}
                                            <Eng>"to make"</Eng>, it would be very uncommon to see{' '}
                                            <TM>li wa te li kama lon</TM>, simply because nobody talks that way. However
                                            it is still allowed.
                                        </P>
                                    </Section>
                                    {/* <Section unofficial>
                                    ...
                                    <Section>
                                        ...
                                        <P>
                                            ...
                                            <TM>nen</TM> meaning <Eng>"because of"</Eng> or <Eng>"caused by"</Eng>. This
                                            is used to mark the <Word>initial cause</Word> of an action.
                                        </P>
                                        <Examples>
                                            <TM>
                                        ...
                                        <P>
                                            This was originally introduced for emotions and <TM>wolin</TM> to make
                                            things less forceful and/or, for lack of a better word, predatory. Consider:
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>mi li wolin e si</TM>
                                                <Answer>
                                                    <Eng>"I love you</Eng>, implying that loving is an action done
                                                    directly <B>to</B> you
                                                </Answer>
                                            </Ex>
                                            <Ex>
                                        ...
                                        <Examples>
                                            <Ex>
                                                ...
                                                <Answer>
                                                    <Eng>"You cause me to make art"</Eng>, strong focus on{' '}
                                                    <Eng>"you"</Eng> being the cause, and the causation itself
                                                </Answer>
                                            </Ex>
                                            <Ex>
                                                <TM>si li pali wa e musi ki mi</TM>
                                                <Answer>
                                                    <Eng>"I make art, and you are the cause"</Eng>, equal focus on the
                                                    act of <Eng>"making art"</Eng>, and on <Eng>"you"</Eng> being the
                                                    cause
                                                </Answer>
                                            </Ex>
                                            <Ex>
                                                ...
                                                <Answer>
                                                    ...
                                                    <Eng>"making art"</Eng> and simply stating that <Eng>"you"</Eng> are
                                                    the reason
                                                </Answer>
                                            </Ex>
                                        </Examples>
                                        <P>
                                            All of these imply that <TM>si</TM> is their muse, their inspiration for
                                            making art, but how much that is a focus of the sentence is changed based on
                                            which sentence structure you choose to use.
                                        </P>
                                        {/* <P>
                                    ...
                                    <Section unofficial>
                                        ...
                                        <P>
                                            While the word <TM>nen</TM> is used to mark the previous cause of a present
                                            action, often times present actions are done in order to cause a future
                                            action. This is precisely the use of the preposition <TM>polo</TM>.{' '}
                                            <TM>polo</TM> marks the <Word>purpose</Word> or <Word>beneficiary</Word> of
                                            an action. Think of it like <Eng>"for"</Eng> or <Eng>"in order to"</Eng> or{' '}
                                            <Eng>"so that"</Eng>.
                                        </P>
                                        <Examples>
                                            <Ex>
                                ...
                                <Section>
                                    ...
                                    <Section>
                                        ...
                                        <P>
                                            ...
                                            ), and <TM>lekin</TM> (<Eng>"but"</Eng>) can be used in almost exactly the
                                            same way as English. You can use them to separate or join sentences,
                                            clauses, individual words, etc. Here is a non-exhaustive list of examples:
                                        </P>
                                        <Examples>
                                            <Ex>
                                                <TM>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        The modifier <TM>pin</TM> is used to mean <Eng>"also"</Eng>,{' '}
                                        <Eng>"as well"</Eng>, <Eng>"too"</Eng>, <Eng>"additionally"</Eng>, etc. In
                                        English,<Eng>"also"</Eng> is an adverb, used to modify a verb (ex:{' '}
                                        <Eng>
                                            "I <B>am also</B> tired"
                                        </Eng>
                                        ,{' '}
                                    ...
                                    <Examples>
                                        ...
                                        <Ex>
                                            ...
                                            <Answer>
                                                ...
                                                , as well as doing other things like review it, pass by it, see it in
                                                the distance...
                                            </Answer>
                                        </Ex>
                                        <Ex>
                                            ...
                                            <Answer>
                                                ...
                                                <br />
                                                The second <TM>pi</TM> is required here because{' '}
                                                <TM>tomo pi moku pin</TM> would mean <Eng>"house of also-food"</Eng>.
                                            </Answer>
                                        </Ex>
                                    </Examples>
                                    <P>
                                    ...
                                    <P>
                                        It is worth noting that the word <TM>taso</TM> can be used to mean{' '}
                                        <Eng>only</Eng>. In this usage, it can be used in much the same way as{' '}
                                        <TM>pin</TM>, modifying different words to imply slightly different results.
                                    </P>
                                </Section>
                                <Section>
                                    <Title id="asking-questions">Asking Questions</Title>
                                    <P>
                                        There are three kinds of questions you may want to ask:{' '}
                                        <Word>polar questions</Word> (yes/no), <Word>open questions</Word> (who/what/why
                                        etc), and <Word>alternative questions</Word> (this or that). Let's go over them
                                        one by one.
                                    </P>
                                    <P>
                                    ...
                                    <P>
                                        ...
                                        <Eng>"yes"</Eng> in most cases where the question is really <B>yes-or-no</B>.
                                        The alternative would be <TM>no</TM> or, rarely, <TM>powe</TM>.
                                    </P>
                                    <P>
                                        You would use the word <TM>tuntan</TM> to mean <Eng>"that is correct"</Eng>, as
                                        a response to someone <B>asking for clarification</B> on a topic. The
                                        alternative would be <TM>no</TM> or <TM>isala</TM>.
                                    </P>
                                    <P>
                                        To ask an <Word>open question</Word>, the special particle <TM>seme</TM> can be
                                        placed as kind of a <B>fill-in-the-blank</B> word. This is best demonstrated
                                        with some examples:
                                    </P>
                                    <Examples>
                                        <Ex>
                                    ...
                                    <P>
                                        Finally, asking an <Word>alternative question</Word>, is kind of a combination
                                        of the other two. It involves asking <B>which option</B> out of a{' '}
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        <Word>aspect</Word> of a verb talks about <B>how</B> the verb happens. Verbs in
                                        toki ma are <Word>tenseless</Word> and <Word>aspectless</Word> by default, so
                                        this would all normally be inferred from context.
                                    </P>
                                    <P>
                                        ...
                                        of a verb, you can use one of three modifiers: <TM>pisile</TM>, <TM>iputu</TM>,
                                        or <TM>akile</TM> for <Eng>"past"</Eng>, <Eng>"present"</Eng>, and{' '}
                                        <Eng>"future"</Eng>.
                                    </P>
                                    <P>
                                        But just because you say <TM>mi li moku iputu</TM>, that doesn't mean everything
                                        is crystal clear yet. That could mean <Eng>"I am eating"</Eng>,{' '}
                                    ...
                                    <Examples>
                                        ...
                                        <Ex>
                                            ...
                                            <TM>mi li moku iputu open</TM> would mean <Eng>"I am starting to eat"</Eng>.
                                            In this case, the action of <Eng>eating</Eng> is currently starting up.
                                        </Ex>
                                        <Ex>
                                            <TM>sajo</TM> indicates <B>continuous</B> action, so{' '}
                                            <TM>mi li moku iputu sajo</TM> would mean <Eng>"I am eating"</Eng>,
                                            spefically stating <Eng>"I am currently in the process of eating"</Eng>. In
                                            this case, the action of <Eng>eating</Eng> is still ongoing.
                                        </Ex>
                                        <Ex>
                                            <TM>pini</TM> indicates <B>finishing</B> action, so{' '}
                                            <TM>mi li moku iputu pini</TM> would mean <Eng>"I am finishing eating"</Eng>
                                            . In this case, the action of <Eng>eating</Eng> is wrapping up.
                                        </Ex>
                                        <Ex>
                                            <TM>mulu</TM> indicates <B>completed</B> actions, so{' '}
                                            <TM>mi li moku iputu mulu</TM> would mean <Eng>"I have eaten"</Eng>,
                                            speficially stating{' '}
                                            <Eng>"I am currently in a state of having completed eating"</Eng>. In this
                                            case, the action of <Eng>eating</Eng> has now stopped.
                                        </Ex>
                                        <Ex>
                                            ...
                                            stating{' '}
                                            <Eng>"Eating is an activity that I currently habitually partake in"</Eng>.
                                            In this case, the action of <Eng>eating</Eng> isn't necessarily happening
                                            right now, but it is still a regular occurrence for the speaker.
                                        </Ex>
                                    </Examples>
                                    <P>
                                        These words can be used to add specificity to your verbs. To be as specific as
                                        possible, you'd have to use <B>both a tense modifier and an aspect modifier</B>.
                                        For example, only using <TM>sajo</TM> without a <B>tense</B> modifier results in
                                        the same type of amiguity as we saw above: the sentence <TM>mi li moku sajo</TM>{' '}
                                        could mean any of <Eng>"I was eating"</Eng>, <Eng>"I am eating"</Eng>, or{' '}
                                        <Eng>"I will be eating"</Eng>, all of which are <B>continuous</B> actions but
                                        have different <B>tense</B>.
                                    </P>
                                    ...
                                    <P>
                                        ...
                                        door while you are eating dinner and you get up to answer the door, your eating
                                        is <TM>pini</TM>, but not <TM>mulu</TM>, because you may sit back down and
                                        continue eating.
                                    </P>
                                    <P>
                                        It is possible to use multiple aspect or tense markers at once to suggest even
                                        more specific verbs. For example, <TM>li moku mulu taka</TM> implies thay you
                                        repeatedly finish eating your food. Maybe you previously used to leave some on
                                        the plate.
                                    </P>
                                    <P>
                                        To reiterate, <B>all of this and more</B> can be often inferred through context
                                        without adding these modifiers, but they're here to use as needed to make sure
                                        you are properly understood. Most of the time, people will not use tense and
                                        aspect modifiers when it is clear enough through context, especially in informal
                                        speech.
                                    </P>
                                </Section>
                                <Separator className="small">* * *</Separator>
                                <Section>
                                    ...
                                    <P>
                                        Without dedicated words for units of time, toki ma has a few conventional
                                        phrases to discuss common units of time. They come in short forms, useful for
                                        when context makes it very obvious that you are talking about time, and long
                                        forms, useful for when context isn't quite enough and you need to be more
                                        specific.
                                    </P>
                                    <table>
                                        <thead>
                                    ...
                                    <Examples>
                                        <Ex>
                                            ...
                                            <Answer>
                                                ...
                                                <Eng>"how much time has passed?"</Eng>, or{' '}
                                                <TM>tenpo li seme (an) iputu</TM>, <Eng>"what time is it now?"</Eng>,
                                                the <TM>an</TM> is optional
                                            </Answer>
                                        </Ex>
                                        <Ex>
                                            ...
                                            <Answer>
                                                ...
                                                <Eng>"the 3rd minute of the 18th hour is ongoing"</Eng>
                                            </Answer>
                                        </Ex>
                                        <Ex>
                                    ...
                                    <P>
                                        ...
                                        <TM>suno 7</TM>, depending on how you think about the order of days, so the
                                        standard term is <TM>suno suno</TM> to make it less confusing. The same is done
                                        for months, with <Eng>January</Eng> being <TM>mun 1</TM>.
                                    </P>
                                </Section>
                                <Section>
                                    <Title id="la-ita">
                                    ...
                                    <P>
                                        The particles <TM>la</TM> and <TM>ita</TM> are used to attach{' '}
                                        <Word>context</Word> phrases to your sentences. With <TM>la</TM>, the context
                                        phrase comes before it and the sentence comes after, and with <TM>ita</TM>, the
                                        context comes after and the sentence comes before.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                    ...
                                    <P>
                                        Yes, that's a pretty vague explanation, but that's kind of the point. "Context"
                                        can be a wide variety of things. Among those is specifying a{' '}
                                        <B>relative time</B> for the entire sentence.
                                    </P>
                                    <P>
                                        All of these example sentences will use <TM>la</TM>, placing the context before
                                        the main sentence, but they could all just as well use <TM>ita</TM> and place
                                        the context at the end. The meaning wouldn't change, this is simply for
                                        convenience of whatever feels more comfortable.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                            ...
                                            <Answer>
                                                ...
                                                <Eng>"in the past days"</Eng>, interpreting <TM>suno</TM> as a plural,
                                                but that is often better represented with <TM>suno mute</TM>
                                            </Answer>
                                        </Ex>
                                        <Ex>
                                            <TM>
                                    ...
                                    <P>
                                        When time is stated through context, the rest of the verbs are then relative to
                                        that time.
                                    </P>
                                    <Examples>
                                        <Ex>
                                    ...
                                    <P>
                                        In that example, it doesn't say{' '}
                                        <Eng>"tonight I have eaten fruit ten times"</Eng>, which wouldn't make sense
                                        because tonight hasn't happened yet. Instead the verb <TM>moku pisile pini</TM>{' '}
                                        is interpreted as if it is already in the future context of <Eng>"tonight"</Eng>
                                        .
                                    </P>
                                    <Examples>
                                        <Ex>
                                    ...
                                    <P>
                                        ...
                                        about something <B>relative to a specific event</B>. For this, we state the
                                        context as literally <Eng>"time that [event] occurred"</Eng> using{' '}
                                        <TM>
                                    ...
                                    <P>
                                        See how when the context is put in the past, the main verb is also interpreted
                                        as being past tense, just like the earlier example with{' '}
                                        <TM>tenpo pimeja ni la</TM>.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                                tenpo te mi li tawa akile ki tomo esun pi moku an, la mi li lanpan esun
                                                e kili
                                            </TM>
                                            <Answer>
                                        ...
                                        <Ex>
                                            <TM>
                                                tenpo pi te mi li tawa akile ki tomo esun pi moku, la mi li lanpan esun
                                                e kili
                                            </TM>
                                            <Answer>
                                                <Eng>"When I go to the grocery store later, I will buy fruit"</Eng>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        <B>specify a relative concept</B> in which to frame the following sentence, or
                                        to <B>change topics</B> similar to the English phrase{' '}
                                    ...
                                    <Examples>
                                        ...
                                        <Ex>
                                            ...
                                            <Answer>
                                                ...
                                                <Eng>
                                                    "On the topic of toki ma grammar, read this guide written by Ta!"
                                                </Eng>
                                                <br />
                                                More literally, it's{' '}
                                                <Eng>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        <Word>conditional</Word> (<Eng>"if [event] occurs, ...</Eng>). The main sentence
                                        is then interpreted as what <B>will/would happen</B> if that condition were
                                        true. By "entire event", I mean a statement that would be complete on its own
                                        such as{' '}
                                        <TM>
                                    ...
                                    <Examples>
                                        ...
                                        <Ex>
                                            ...
                                            <Answer>
                                                ...
                                                <br />
                                                Because the context is past tense, the main sentence is interpreted as
                                                what would have happened in that hypothetical past.
                                            </Answer>
                                        </Ex>
                                        <Ex>
                                            <TM>
                                                si li wile te li tawa ki tomo pi moku, la mi li wile te li tawa kan si
                                            </TM>
                                            <Answer>
                                                <Eng>
                                                    "If you want go to the restaurant, then I want to go with you"
                                                </Eng>
                                            </Answer>
                                        </Ex>
                                    </Examples>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        The preposition <TM>an</TM> meaning <Eng>in</Eng>, <Eng>at</Eng>, or{' '}
                                        <Eng>on</Eng> is used to state both <Word>times</Word> and{' '}
                                        <Word>locations</Word>, adding yet another way to talk about time in toki ma.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        thought through your sentence by the time you've started speaking and you
                                        realize you want to add more context.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                                pawo la, iputu la, on li pasan wa ki mi, lekin munkin la, akile la, on
                                                li lakima wa ki mi ita on li kuton wa ki mi
                                            </TM>
                                            <Answer>
                                                <Eng>
                                    ...
                                    <P>
                                        This sentence is very awkward in writing, but in spoken language this kind of
                                        thing is reasonably common.
                                    </P>
                                </Section>
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        reflect different ideas. There are many possible moods, each with technical
                                        names, and each used for different ways of speaking: stating facts, asking
                                        questions, talking about wishes, discussing hypotheticals, the list goes on.
                                    </P>
                                    <P>
                                        You've already learned how to use quite a few of these moods so far: you can
                                        state commands, requests, and desires with <TM>o</TM>, you can ask questions
                                        with <TM>seme</TM>, you can create conditionals with <TM>la</TM> or <TM>ita</TM>{' '}
                                        to talk about hypotheticals, and more. Not every grammatical mood that
                                        grammarians have defined have unique equivalents in toki ma, but there are
                                        creative ways to approximate many of them to either directly state or heavily
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <br />
                                                    This is not imperative only because of the context of the statement.
                                                    It is clearly a wish and not a command.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Jussive</td>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        <Eng>"to do"</Eng> is considered to be the <B>generic verb</B> in toki ma,
                                        similar to how <TM>sa</TM> meaning <Eng>"object"</Eng> or <Eng>"thing</Eng> is
                                        the generic noun. When used to mean <Eng>"to do"</Eng>, <TM>pali</TM> is rarely
                                        seen in statements on its own, usually appearing in questions, or when
                                        accompanied by demonstrating an action.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>mi li pali su ni</TM>
                                            <Answer>
                                                <Eng>"I do it like this"</Eng>, usually followed by a demonstration of
                                                the action you're doing
                                            </Answer>
                                        </Ex>
                                        <Ex>
                                    ...
                                    <P>
                                        When used to mean <Eng>"to make"</Eng>, the word is much more descriptive,
                                        acting the same as any other verb.
                                    </P>
                                </Section>
                                <Section>
                                    <Title id="pelu">
                                    ...
                                    <P>
                                        The preposition <TM>pelu</TM> marks the <Word>instrument</Word> of a sentence,
                                        roughly equivalent to <Eng>"using"</Eng>, <Eng>"with the use of"</Eng>, or{' '}
                                        <Eng>"with the help of"</Eng>. This is used to demonstrate <B>use of tools</B>{' '}
                                    ...
                                    <Examples>
                                        ...
                                        <Ex>
                                            ...
                                            <Answer>
                                                <Eng>"I won with the help of my sibling"</Eng>, implying you did the
                                                winning and they only provided assistance, as opposed to winning "along
                                                with" your sibling as if they were on the same team.
                                            </Answer>
                                        </Ex>
                                    </Examples>
                                </Section>
                                <Section>
                                    ...
                                    <P>
                                        The preposition <TM>kan</TM> indicates <Word>accompaniment</Word>, roughly
                                        equivalent to <Eng>"together with"</Eng>, <Eng>"among"</Eng>, or{' '}
                                        <Eng>"in the company of"</Eng>. This is used for doing actions <B>along with</B>{' '}
                                        a person or group.
                                    </P>
                                    <Examples>
                                        <Ex>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        The preposition <TM>ki</TM> marks the <Word>destination</Word> or{' '}
                                        <Word>recipient</Word> of an action. This is roughly equivalent to{' '}
                                        <Eng>"to"</Eng> or <Eng>"until [a time]"</Eng>. This is used to indicate{' '}
                                        <B>motion towards</B> an object or place, to mark <B>the recipient</B> of an
                                        action, or to specify the end of a time range. It is this recipient marking that
                                        is the reason we use <TM>ki</TM> for causative-<TM>wa</TM> phrases, as
                                ...
                                <Section>
                                    ...
                                    <P>
                                        The preposition <TM>tan</TM> marks the <Word>origin</Word> or{' '}
                                        <Word>source</Word>, roughly equivalent to <Eng>"from"</Eng>, or{' '}
                                        <Eng>"starting at [a time]"</Eng>. This is used to indicate{' '}
                                        <B>motion away from</B> an object, to show the originating source of an object,
                                        or to specify the end of a time range.
                                    </P>
                                    <Examples>
                                        <Ex>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        <Eng>"bigger than"</Eng>, <Eng>"less cold than"</Eng>, etc., stating{' '}
                                        <B>relative</B> comparisons between things.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                    ...
                                    <P>
                                        Unlike other prepositions in toki ma, <TM>su</TM> can be{' '}
                                        <B>directly followed</B> by another preposition in comparative sentences.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                        ...
                                        <Ex>
                                            ...
                                            <Answer>
                                                <Eng>
                                                    "I go to the restaurant more often with you than with my parents"
                                                </Eng>
                                                , literally{' '}
                                                <Eng>
                                    ...
                                    <P>
                                        ...
                                        <Eng>"near"</Eng> and <Eng>"specific"</Eng>, to differentiate between things
                                        being exactly the same or just similar. Without them, the degree of similarity
                                        is implied through context, as is true of so much of toki ma.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        Unlike comparatives, <Word>superlatives</Word> state <B>absolute</B>{' '}
                                        comparisons: <Eng>"best"</Eng>, <Eng>"most enjoyable"</Eng>,{' '}
                                        <Eng>"fastest"</Eng>. For this, you can use the phrase <TM>sata su ali</TM>,
                                        meaning <Eng>"more than all"</Eng>.
                                    </P>
                                    <Examples>
                                        <Ex>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        <TM>wan</TM>, <TM>tu</TM>, <TM>san</TM>, ..., <TM>ten</TM>, <TM>kenta</TM>,
                                        etc.), but how do you put these words together to form other numbers? It's
                                        actually very much like you would do it in English! There is no such thing as a
                                        modifier form of a number, they all act as connected nouns. Let's look at
                                        examples and it will all be clear.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>ten tu</TM>
                                ...
                                <Section unofficial>
                                    ...
                                    <P>
                                        The word <TM>nula</TM> is used for <Eng>"zero"</Eng>, though, like in English,
                                        it doesn't often appear in compound whole number words. You don't find yourself
                                        saying <Eng>"four thousand, zero hundred, and fifty six"</Eng>, do you? That
                                        said, zero is still a very important concept. Until this becomes official, the
                                        word <TM>no</TM> can be used as a number word to mean <Eng>"zero"</Eng>.
                                    </P>
                                    <P>
                                        With this change, <TM>nula</TM> would be used for negation in place of{' '}
                                        <TM>no</TM> to say things like <Eng>"without"</Eng> in sentences like:
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        <Word>Cardinal</Word> numbers are placed <B>before the noun</B>. These are used
                                        for counting <B>how many</B> or <B>how much</B> of something there is.
                                    </P>
                                    <Examples>
                                        <Ex>
                                            <TM>
                                    ...
                                    <P>
                                        ...
                                        <Eng>"three hours"</Eng>, and <TM>"osa san"</TM> to mean{' '}
                                        <Eng>"three o'clock"</Eng>, literally <Eng>"third hour"</Eng>.
                                    </P>
                                ...
                                <Section>
                                    <Title id="fractions-decimals-and-percents">
                                    ...
                                    <P>
                                        To talk about <B>decimals</B> we use{' '}
                                        <TM>[whole number] suti [decimal digits]</TM>. Decimal digits are stated one by
                                        one using single digit number words.
                                    </P>
                                    <Examples>
                                        <Ex>
                                    ...
                                    <P>
                                        To talk about <B>percentages</B> we add the word <TM>senti</TM> to the end of
                                        the number. This can be combined with decimal notation to specify decimal
                                        percentages.
                                    </P>
                                    <Examples>
                                        <Ex>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        ...
                                        <Eng>"addition"</Eng> or <Eng>"multiplication"</Eng>, other descriptions can be
                                        used to talk about the operations in a mathematical context.
                                    </P>
                                    <table>
                                        <thead>
                                            <tr>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        There are no dedicated words for the cardinal directions in toki ma. As such,
                                        the words for <Eng>"north"</Eng>, <Eng>"south"</Eng>, <Eng>"east"</Eng>, and{' '}
                                        <Eng>"west"</Eng> are defined relative to something that is constant regardless
                                        of your first language: the motion of the Sun. We talk about the directions{' '}
                                        <B>from the Sun's perspective</B>, meaning <Eng>"west"</Eng> is considered
                                        foreward, and <Eng>"north"</Eng> is considered to the right.
                                    </P>
                                    <table>
                                        <thead>
                                            <tr>
                                ...
                                <Section>
                                    ...
                                    <P>
                                        In order to fulfill the goal of an international language, it is best to try to
                                        use toki ma words to describe the things you are talking about. However, there
                                        are times when you will want to use names or words from outside toki ma in the
                                        interest of clarity, accuracy, or just general ease of use.
                                    </P>
                                    <P>
                                        When using external names or words, you have a few options. You may choose to
                                        either use the Latin script spelling of the word or name, or you can
                                        transliterate it into the sounds that toki ma has to offer. So the name{' '}
                                        <Eng>"Angela"</Eng> could be spelled{' '}
                                        <TM>
                                        ...
                                        , etc. Any of these are acceptable. If you choose not to transliterate the name
                                        into toki ma, there is no guarantee how someone else may pronounce it based on
                                        their native language.
                                    </P>
                                    <P>
                                        Additionally, you can prefix the word or name with the toki ma word for the type
                                        of thing it is. If you're naming a person, it's common to say{' '}
                                        <TM>
                                            jan <Transliterated>Ankela</Transliterated>
                                        </TM>
                                        , making it clear that this is the name of a <TM>jan</TM>. If you're naming a
                                        food, you might prefix it with <TM>moku</TM>, such as{' '}
                                        <TM>
                                    ...
                                    <P>
                                        ...
                                        Including a prefix word is often seen as more formal, but it's not at all
                                        uncommon in informal speech either.
                                    </P>
                                </Section>
                                <Section>
                                    <Title id="peko-and-a">
                                    ...
                                    <P>
                                        There are two words in toki ma that don't really fit into any other group
                                        nicely: <TM>peko</TM> and <TM>a</TM>. They are both used as <B>interjections</B>{' '}
                                        rather than standard words.
                                    </P>
                                    <P>
                                        Use <TM>peko</TM> to show <B>humility</B> and <B>politeness</B>. It is used for
                                        phrases like <Eng>"please"</Eng>, <Eng>"excuse me"</Eng>,{' '}
                                        <Eng>"you're welcome"</Eng>, <Eng>"hello"</Eng>, <Eng>"thank you"</Eng>, and
                                        many other polite phrases.
                                    </P>
                                    <P>
                                    ...
                                    <P>
                                        Both are used in both formal and informal speech. In informal speech,{' '}
                                        <TM>peko</TM> is often seen as friendliness rather than strictly politeness.
                                    </P>
                                </Section>
                                <Section>
                                    <Title id="notes">Notes</Title>
                                    <P>
                                        Many words and/or common constructions have some specifics in their use or
                                        meaning that may not be obvious in the definition. This chart contains notes
                                        about specific constructions and how they are used.
                                    </P>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <B>animate objects</B>. You wouldn't often use it to refer to a
                                                    previous subject as "it" like you would in English. For that you'd
                                                    probably use <TM>ni</TM> and <TM>na</TM> for <Eng>this</Eng> and{' '}
                                                    <Eng>that</Eng>.
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <Eng>"to create"</Eng>, <B>never</B> <Eng>"to cause"</Eng>. English
                                                    uses the word for both meanings, but for causation in toki ma you
                                                    can only use <TM>wa</TM>.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <br />
                                                    In toki ma, the idea of <Eng>"on"</Eng> is already built into the
                                                    verb <TM>[li] siten</TM>, meaning <B>it is transitive</B> by
                                                    default. You would say <TM>mi li siten e siten</TM>:{' '}
                                                    <Eng>"I sit-on a seat"</Eng>, using <TM>e</TM> rather than{' '}
                                                    <TM>an</TM>.
                                                    <br />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    There is no specific word for <Eng>"any"</Eng> in toki ma, so
                                                    instead the words <TM>wan (pi)</TM> and <TM>osa pi</TM> are used to
                                                    approximate it in different cases.
                                                    <br />
                                                    <Examples>
                                                        <Ex>
                                                    ...
                                                    Because <TM>kule</TM> can be either singular or plural, both of
                                                    these answers are equally valid. Context would, of course, tell you
                                                    more.
                                                </td>
                                            </tr>
                                        </tbody>
